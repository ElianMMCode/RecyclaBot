...
fk_city_id INT UNIQUE NOT NULL,
fk_town_id INT UNIQUE NOT NULL,
latitude INT,
longitude INT,
adress VARCHAR(150),
...
fk_price_table_id INT UNIQUE NOT NULL
);
...
link VARCHAR (255),
fk_publication_type_id INT UNIQUE NOT NULL
);
...
link VARCHAR(255),
fk_publication_id INT UNIQUE NOT NULL
);
...
fk_material_id INT UNIQUE NOT NULL,
...
ALTER TABLE tb_ECA_points ADD FOREIGN KEY (fk_price_table_id) REFERENCES tb_price_tables (price_table_id);
