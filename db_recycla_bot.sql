...
recycler_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
fk_people_id INT NOT NULL
);
...
price_table_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
ALTER TABLE tb_citizens ADD FOREIGN KEY (fk_people_id) REFERENCES tb_people (people_id);
ALTER TABLE tb_admin ADD FOREIGN KEY (fk_people_id) REFERENCES tb_people (people_id);
ALTER TABLE tb_recyclers ADD FOREIGN KEY (fk_people_id) REFERENCES tb_people (people_id);
ALTER TABLE tb_favorites ADD FOREIGN KEY (fk_people_id) REFERENCES tb_people (people_id);
ALTER TABLE tb_favorites ADD FOREIGN KEY (fk_module_id) REFERENCES tb_modules (module_id);
ALTER TABLE tb_notification ADD FOREIGN KEY (fk_people_id) REFERENCES tb_people (people_id);
...
ALTER TABLE tb_answers ADD FOREIGN KEY (fk_people_id) REFERENCES tb_people (people_id);
ALTER TABLE tb_comments ADD FOREIGN KEY (fk_people_id) REFERENCES tb_people (people_id);
...
ALTER TABLE tb_modules ADD FOREIGN KEY (fk_notice_id) REFERENCES tb_publications (publication_id);
